...
<!--<![endif]-->
	<head>
		...
		<!-- Plugins -->
		<link href="<?php echo base_url() ?>public/css/animations.css" rel="stylesheet">
					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="logo smooth-scroll">
								<a href="#banner"><img id="logo" src="<?php echo base_url() ?>public/images/logo.png" alt="Worthy"></a>
							</div>
